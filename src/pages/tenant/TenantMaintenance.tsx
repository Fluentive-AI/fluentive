...
const TenantMaintenance: React.FC<TenantMaintenanceProps> = ({ scenario: propScenario }) => {
  const { scenario: urlScenario } = useParams<{ scenario?: string }>();
  const scenario = propScenario || urlScenario || 'request';
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <h1 className="text-2xl font-semibold mb-6">Maintenance AI Assistant Demo: {scenario}</h1>

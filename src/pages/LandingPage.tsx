...
import { ArrowRight, Check, BarChart3, MessageSquare, Clock, ArrowUpRight } from 'lucide-react';
...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="w-full py-4 px-8 border-b flex items-center justify-between sticky top-0 bg-white/95 backdrop-blur-sm z-10 shadow-sm">
        ...
        <div>
          <Button 
            ...
            className="hidden md:flex items-center gap-1 bg-brand-500 hover:bg-brand-600"
          >
            Try Demo
      ...
      {/* Hero Section */}
      <section className="py-24 px-8 bg-gradient-to-br from-blue-50 via-white to-indigo-50">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-6">
                <Button 
                  size="lg" 
                  className="text-lg px-8 py-6 h-auto bg-brand-500 hover:bg-brand-600 font-medium shadow-md hover:shadow-lg transition-all"
                  onClick={() => navigate('/login')}
                >
            ...
            <div className="md:w-1/2">
              <div className="rounded-xl border shadow-2xl overflow-hidden transform md:rotate-1 hover:rotate-0 transition-all duration-300">
                <img 
      ...
      <section id="features" className="py-24 px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="border rounded-xl p-8 shadow-sm hover:shadow-md transition-all duration-200 group hover:bg-blue-50">
            ...
            {/* Feature 2 */}
            <div className="border rounded-xl p-8 shadow-sm hover:shadow-md transition-all duration-200 group hover:bg-indigo-50">
            ...
            {/* Feature 3 */}
            <div className="border rounded-xl p-8 shadow-sm hover:shadow-md transition-all duration-200 group hover:bg-emerald-50">
          ...
          <div className="text-center mt-16">
            <Button 
              size="lg" 
              onClick={() => navigate('/login')}
              className="bg-brand-500 hover:bg-brand-600 font-medium shadow-md hover:shadow-lg transition-all"
            >
      ...
      {/* Benefits Section */}
      <section id="benefits" className="py-24 px-8 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <div className="space-y-10">
              <div>
                <h3 className="text-2xl font-bold mb-4 flex items-center">
                  <span className="bg-brand-500 text-white rounded-full w-10 h-10 flex items-center justify-center mr-4 shadow-md">1</span>
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 flex items-center">
                  <span className="bg-brand-500 text-white rounded-full w-10 h-10 flex items-center justify-center mr-4 shadow-md">2</span>
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 flex items-center">
                  <span className="bg-brand-500 text-white rounded-full w-10 h-10 flex items-center justify-center mr-4 shadow-md">3</span>
      ...
      {/* Final CTA Section */}
      <section className="py-24 px-8 bg-gradient-to-br from-brand-600 to-blue-600 text-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center">
            ...
            <Button 
              size="lg"
              className="bg-white text-brand-600 hover:bg-white/90 text-lg px-10 py-7 h-auto font-medium shadow-xl hover:shadow-2xl transition-all"
              onClick={() => navigate('/login')}
            >
      ...
      <footer className="py-16 px-8 bg-gray-900 text-gray-300">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            <div>
              <h3 className="font-bold text-white text-lg mb-4">PropertyAI</h3>

...
// Define categories with their options
const LEASING_CATEGORIES = {
  leasing: [
    ...
    { value: 'approval_process', label: 'Approval Process' },
  ],
  other: [
    { value: 'pricing_fees', label: 'Pricing & Fees' },
    { value: 'amenities', label: 'Amenities' },
    { value: 'availability', label: 'Availability' },
    { value: 'policies', label: 'Policies' },
    { value: 'location_info', label: 'Location Info' },
  ]
};
